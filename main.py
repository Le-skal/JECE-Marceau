    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:  # Quit if ESC is pressed
                    pygame.quit()
                    sys.exit()
...
def main():
    ...
    while True:
        ...
        if remaining_time <= 0 or score >= max_score:
            break
