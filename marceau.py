...
class Marceau:
    def __init__(self, screen_width, screen_height, size, horizontal_movement=False):
        ...
        self.y = random.randint(-100, -size)            # Position initial verticalement (au dessus de l'ecran)
        self.size = size
    ...
    def is_caught(self, player):
        ...
        return player_rect.colliderect(marceau_rect)    # Retourne True si le rectangle du marceau entre en collision avec celui du joueur
